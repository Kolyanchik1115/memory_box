...
import 'package:memory_box/widgets/home_audio_container_widget.dart';
...
import '../collection_page/main_collection_page/widgets/item_collection.dart';
                      ...
                      if (state.listCollectionModels.isNotEmpty)
                        SizedBox(
                          ...
                          child: ItemCollection(
                            pathToImage:
                                state.listCollectionModels[0].pathToImage,
                            titleOfCollection:
                        ...
                        children: [
                          if (state.listCollectionModels.length > 1)
                            SizedBox(
                              ...
                              child: ItemCollection(
                                pathToImage:
                                    state.listCollectionModels[1].pathToImage,
                                titleOfCollection: state
                                    .listCollectionModels[1].titleOfCollection,
                                counterAudio: state.listCollectionModels[1]
                                    .idAudioModels.length
                                    .toString(),
                                totalDuration: totalDurationSeconds(state
                                    .listCollectionModels[1]
                                    .allTimeAudioCollection),
                                onTap: () {
                                  context.read<CollectionBloc>().add(
                                      CollectionGetCardInitial(
                                          collectionAudioModel:
                                              state.listCollectionModels[1]));
                                },
                              ),
                            )
                          else
                          ...
                          if (state.listCollectionModels.length > 2)
                            SizedBox(
                              ...
                              child: ItemCollection(
                                pathToImage:
                                    state.listCollectionModels[2].pathToImage,
                                titleOfCollection: state
                                    .listCollectionModels[2].titleOfCollection,
                                counterAudio: state.listCollectionModels[2]
                                    .idAudioModels.length
                                    .toString(),
                                totalDuration: totalDurationSeconds(state
                                    .listCollectionModels[2]
                                    .allTimeAudioCollection),
                                onTap: () {
                                  context.read<CollectionBloc>().add(
                                      CollectionGetCardInitial(
                                          collectionAudioModel:
                                              state.listCollectionModels[2]));
                                },
                              ),
                            )
                          else
